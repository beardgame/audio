...
namespace Bearded.Audio
{
    ...
    {
        public virtual void Delete(int handle)
        {
            Context.Call(AL.DeleteSource, handle);
        }

        public virtual int Generate()
        {
            return Context.Eval(AL.GenSource);
        }
        ...
        public virtual void Pause(int handle)
        {
            Context.Call(AL.SourcePause, handle);
        }

        public virtual void Play(int handle)
        {
            Context.Call(AL.SourcePlay, handle);
        }
        ...
        public virtual void Rewind(int handle)
        {
            Context.Call(AL.SourceRewind, handle);
        }
        ...
        {
            Context.Call(AL.SourceStop, handle);
        }
